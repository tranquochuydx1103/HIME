...
public class Run {
	...
	/** Default input **/
	//paa: Số khoảng trục y giữa max và min giá trị chuỗi
	//a: Số khoảng, số giá trị trong 1 khung cửa sổ sau khi xử lý qua thuật toán PAA
	//x: Số giá trị của chuỗi trong 1 khung cửa sổ
